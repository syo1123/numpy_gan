...
batch_size=64
d= np.load("./cat2.npy", allow_pickle=True)
tensor_x = torch.from_numpy(d).float()
data= torch.utils.data.DataLoader(tensor_x, batch_size=64, shuffle=True)
